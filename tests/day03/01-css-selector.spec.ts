...
// CSS Selector Locators - https://playwright.dev/docs/locators#locate-by-css-or-xpath
...
test("CSS Selector Locators", async ({ page }) => {
  ...
  await page
    .locator('[class="form-control ng-untouched ng-pristine ng-invalid"]')
    .nth(1)
  ...
  await page
    .locator('input[formcontrolname="city"][id="city"]')
