...
test('Xpath Locators', async ({ page }) => {
    ...
    await page.locator('//input[@id="last_name" and @placeholder="Your last name *"]').fill('Doe');
    ...
    await expect(page.locator('//h3[contains(text(), "Customer registration")]')).toBeVisible();
});
